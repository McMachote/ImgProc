...
public class PeakSignalToNoiseRatio extends Operation {
	...
	public PeakSignalToNoiseRatio(String img_string) throws InterruptedException {
        super(img_string);
    }
